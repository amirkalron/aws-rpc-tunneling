 ...
 * 
 * how? both sides,Sender and Receiver, are polling the messages from amazon SQS
 * - Sender from responses "Qname_responses" Receiver from requests
 * "Qname_responses"
 * 
 * This is a better approach then creating an SSH tunnel since it works on a
 * distributed environment, where multiple server IP's and credentials are not
 * needed *
 * 
 * @author kalron
 */
